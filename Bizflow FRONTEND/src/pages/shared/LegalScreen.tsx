    ...
    <MainLayout>
      <div className="max-w-3xl mx-auto space-y-8 pb-20">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate(-1)} className="p-2 -ml-2 text-neutral-textMid hover:text-primary transition-standard">
            <ChevronLeft size={24} />
          </button>
          <div>
            <h2 className="text-2xl">{isTerms ? 'Terms and Conditions' : 'Privacy Policy'}</h2>
            <p className="text-neutral-textLight text-xs">Last updated: April 2026</p>
          </div>
        </div>
        ...
        <Card className="prose prose-sm max-w-none p-8 space-y-6">
          ...
          {isTerms ? (
            <div className="space-y-6 text-neutral-textMid text-sm leading-relaxed">
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">1. Acceptance of Terms</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">2. Description of Service</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">3. User Responsibilities</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">4. Data Ownership</h3>
            ...
            <div className="space-y-6 text-neutral-textMid text-sm leading-relaxed">
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">1. Information We Collect</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">2. How We Use Information</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">3. Data Security</h3>
              ...
              <section>
                <h3 className="text-neutral-darkNavy font-bold text-base mb-2">4. Third-Party Services</h3>
          ...
          <div className="pt-10 border-t border-neutral-border text-center text-xs text-neutral-textLight">
